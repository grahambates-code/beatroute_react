...
export default class extends Component {
    ...
    render() {
        ...
        const actions = [
            {
                icon: <DeleteCard refetch={refetch} card={card} />,
                name: 'Delete',
            },
            {
                icon: <AddAsset refetch={refetch} card={card} />,
                name: 'Add annotation',
            },
        ];

        return (
            <Overlay card={props.card} button={<Button actions={actions} />}>
                {' '}
                                    ...
                                    return (
                                        <div>
                                            ...
                                            <Deck
                                                ...
                                                updateSlideMedia={updateSlideMedia}
                                                updateMap={updateMap}
