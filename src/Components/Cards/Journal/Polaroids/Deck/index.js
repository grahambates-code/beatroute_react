...
import PP from './Layers/PolaroidAndPhoto';
...
export default class extends React.Component {
    constructor(props) {
        ...
        this.state = {
            firstLoad: true,
            viewState: {
                orth: this.props.card.camera || {
                    orbitAxis: 'Z',
                    rotationX: 0,
                    rotationOrbit: 0,
                    target: [0, 0, 0],
                    zoom: 2.5998110489966852,
                },
            },
        };
    ...
    render() {
        let layers = [
            new PP({
                ...
                data: [{ position: [-10, -10, 0.0], angle: 5 }],
            }),
            new PP({
                id: this.props.card.id + '2',
                data: [{ position: [0, 90, 0.0], angle: -5 }],
            }),
            new PP({
                id: this.props.card.id + '3',
                data: [{ position: [0, 180, 0.0], angle: 5 }],
            }),
        ];
