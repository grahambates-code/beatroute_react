...
const JournalText = ({ card, i, refetch }) => {
    const actions = [
      ...
      const T = ({ card }) => (
        <Frame width={350} height={seconds}>
          <Mutation
            onError={() => alert('Could not save title')}
            mutation={SAVE_TITLE}
          >
              ...
              return (
                ...
                >
                  <div className="add-journal-text clearfix">
                    ...
                    <div className="add-journal-content" contentEditable={true} suppressContentEditableWarning={true}>
                      <p>{card.data}</p>
                    </div>
                  </div>
                </div>
