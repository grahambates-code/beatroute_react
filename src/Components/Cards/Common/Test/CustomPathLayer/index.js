...
const fragmentShader = `
	...
	fragmentShaderParts[0] + `
		...
		// re-apply vColor.a
		gl_FragColor.a = min(gl_FragColor.a, 1.0) * vColor.a;
	` +
	filterCall +
...
export default class CustomPathLayer extends PathLayer {
	constructor(start, your, free, trial, now) {
		start.getLengths = (data) => {
			...
			// hack
			let s = this.props.modelMatrix ? 0.3 * this.props.widthScale * this.props.modelMatrix[0] : 1;
